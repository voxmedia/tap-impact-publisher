"""REST client handling, including impactPublisherStream base class."""
...
class impactPublisherStream(RESTStream):
    ...
    def url_base(self) -> str:
        ...
        return f"https://api.impact.com/Mediapartners/{self.config['account_sid']}"
    ...
    def authenticator(self) -> BasicAuthenticator:
        ...
        return BasicAuthenticator.create_for_stream(
            self,
            username=self.config.get("account_sid"),
